            ...
            <div class="row">
                <div class="col col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="contact-intro">
                        <span>A Designed By <i>Atik Hassan Himel</i></span>
                    </div>
                </div>
                <div class="col col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="contact-info">
                        <ul>
                            <li><a href="tel:869968236"><span>Need help? Call Us:</span>01978835624</a></li>                                    <li>
                                <li>
                                <div class="dropdown">
        ...
        <div class="row align-items-center">
            <div class="col-lg-2">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html"><img width="150px" src="{{ asset('uploads/logo') }}/{{ App\Models\Logo::where('location','main')->first()->logo }}" alt="logo"></a>
                </div>
            </div>
                            ...
                            <ul id="metis-menu">
                                ...
                                <li class="header-catagory-item">
                                    ...
                                    <ul class="header-catagory-single">
                                        ...
                                        @empty
                                        <span colspan="4" class="text-center text-danger">No Subcategory Found</span>
                ...
                <div class="col col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="widget link-widget">
                        ...
                        <div class="contact-ft">
                            <ul>
                                <li><i class="fi flaticon-mail"></i>atikhassanhimel92@gmail.com</li>
                                <li><i class="fi flaticon-phone"></i>01978835624</li>
                                <li><i class="fi flaticon-pin"></i>Dhaka, Bangladesh</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col col-xs-12">
                    <p class="copyright">Designed By <i>Atik Hassan Himel</i></p>
...
@php
    $dates = $upcommingOffer->take(1)->first()->date;

    $aaa = str_replace('-','/',$dates)
@endphp
<script>

     if ($("#clock").length) {
        $('#clock').countdown('{{ $aaa }}', function (event) {
